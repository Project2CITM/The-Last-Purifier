...
{
	renderObjects[0].InitAsTexture(app->textures->Load("Sprites/Player/Icons/RevenantSpriteInHub.png", false, false),pos, { 0,0,0,0 },1.5f,2,0.8f);
	renderObjects[1].InitAsTexture(app->textures->Load("Sprites/Player/Icons/SageSpriteInHub.png",false,false), pos, { 0,0,0,0 }, 0.85f, 2, 0.8f);//870,1970
