...
public:
	...
	void AddTextureRenderQueue(SDL_Texture* texture, iPoint pos, SDL_Rect section = {0,0,0,0}, float scale = 1, int layer = 0, float orderInlayer = 0.0f, float rotation = 0, SDL_RendererFlip flip = SDL_FLIP_NONE, float duration = 1.0f);// Speed = 1.0f = Fullscreen camera
	...
	/// <param name="orderInlayer"></param>
	/// <param name="speed"></param>
	void AddRectRenderQueue(const SDL_Rect& rect, SDL_Color color = { 0,0,0,255 }, bool filled = true, int layer = 1, float orderInlayer = 0.0f, float duration = 1.0f);
